...
function changeProducts(id , elm) {
    document.querySelectorAll(".menu-best-sale-title-item").style.backgroundColor = 'transparent'
...
function renderProduct(arr) {
   ...
   for(let i = 0; i < arr.length; i++){
        ...
        <div class="menu-best-sale-content-item-content">
             ...
             <div class="price">
                 <div class="price-old"><del>${arr[i].giacu}</del></div>
                 <div class="price-new">${arr[i].giamoi}</div>
             </div>
        </div>
 </div>
        `;

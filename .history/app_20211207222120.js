...
function checkBill(){
     document.getElementsByClassName('btn-checkoutpage')[0].addEventListener('click', function(){
...
//     document.getElementsByClassName('navbar-menu-item').classList.add('active2')
//   }

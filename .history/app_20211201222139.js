 ...
 function timKiemNangCao() {
     ...
     if (sort == "LowToHeight")
         for (i = 0; i < product_sort.length - 1; i++) {    
          console.log(typeof(Number(product_sort[i].giamoi.replace('đ',''))))
             for (j = i+1; j < product_sort.length; j++)
                 if (product_sort[i].giamoi.replace('đ',"") * 1 > product_sort[j].giamoi.replace('đ','') * 1) {
     ...
     for (i = 0; i < product_sort.length; i++) {
         ...
         // Đưa sản phẩm vào giao diện
              ...
              <div class="menu-best-sale-content-item col-3 col-md-4 col-sm-6">
              <div class="menu-best-sale-content-item-img">
              <img src= ${product_sort[i].anh} alt="" class="product-img">
                     <i class='bx bx-bullseye product-icon'onclick="ModalProduct('${product_sort[i].anh}' , '${product_sort[i].ten}' , '${product_sort[i].giacu}', '${product_sort[i].giamoi}', '${product_sort[i].anh}', '${product_sort[i].anh1}' , '${product_sort[i].anh2}','${product_sort[i].anh3}' )"></i>
                     <i class='bx bx-shopping-bag product-icon btn-add' onclick="ModalCart('${product_sort[i].anh}', '${product_sort[i].ten}', '${product_sort[i].giamoi}')"></i>
                     <h5 class="discount">-12%</h5>
              </div>
      
              <div class="menu-best-sale-content-item-content">
                   <h3 class="item-content-name">${product_sort[i].ten}</h3>
                   <div class="price">
                       <div class="price-old price-item"><del>${product_sort[i].giacu}</del></div>
                       <div class="price-new price-item">${product_sort[i].giamoi}</div>
         ...
         searchContent.innerHTML = contentProduct

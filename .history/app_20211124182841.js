...
function ModalCart(anh,ten,gia){
    ...
    let total = gia
     ...
     document.getElementById('number-total').innerText = (total_price * 1000000 + parseFloat(total) * 1000000).toLocaleString() + 'đ';
...
function tinhTien() {
     ...
     let price = document.getElementById('number-total');
         price.innerHTML = (100000 * quantityInput.value * 1 + 1000000).toLocaleString() + 'đ';

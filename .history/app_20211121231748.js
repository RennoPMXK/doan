...
function getInfoProduct(){
    var btnsAdd = document.querySelectorAll('product-icon:last-of-type')
    for (var i = 0; i < btnsAdd.length; i++){
         var button = btnsAdd[i]
...
function addToCartClicked(e){
      ...
      var title = productItem.getElementByClassName('item-content-name')[0].innerText
      console.log(title)
}

...
function InnerBill(){
    ...
    <th  width="400px" height="40px" >Mã đơn hàng</th>
    <th width= "400px">Trạng thái</th>
    <th width= "400px">Xử lý</th>
    </tr>
    `
         ...
         content.classList.add('checkout-item')
                   ...
                   for(let j = 0; j < detailBill_arr.length; j++){
                      ...
                      if(bill_arr[i].xuly == 1) {
                        content.innerHTML = `
                        <th onclick = "ShowDetailBill('${bill_arr[i].mahd}')" id="bill-num" >
                          ${bill_arr[i].mahd}
                        </th>
                        ...
                        content.innerHTML = `
                        <th onclick = "ShowDetailBill('${detail}')" id="bill-num" >
                          ${bill_arr[i].mahd}
                        </th>
...
function ShowDetailBill(a){
    console.log(a)
  document.getElementsByClassName('modal-description')[0].innerHTML = 'tri nguyen'
}

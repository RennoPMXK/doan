  ...
  document.getElementById(type).innerHTML = `
    <div class="menu-best-sale-content-item col-3">
         <div class="menu-best-sale-content-item-img">
            <img src="${product_list.img}" alt="" class="product-img">
         ...
         <div class="menu-best-sale-content-item-content">
             <h3 class="item-content-name">${product_list.ten}</h3>
         <div class="price">
             <div class="price-old"><del>${product_list.giacu}</del></div>
             <div class="price-new">${product_list.giamoi}</div>
         </div>
      </div>
   </div>
             `

...
function renderProduct(arr) {
   ...
   for(let i = 0; i < arr.length; i++){
        ...
        <img src= ${arr[i].anh} alt="" class="product-img">
               <i class='bx bx-bullseye product-icon'onclick="ModalProduct('${arr[i].anh}' , '${arr[i].ten}' , '${arr[i].giacu}', '${arr[i].giamoi}')"></i>
...
function ModalProduct(anh,ten,giacu,giamoi) {
     modal.classList.add('active');
     modalProduct.style.display = 'block';   
     document.querySelector('.modal-left-top img').src = anh
     document.querySelector('.modal-right h3').innerText = ten
     document.querySelector('.modal-price-old').innerText = giacu
     document.querySelector('.modal-price-new').innerText = giamoi
}

function ChangeModalPicture(){
     var Imgmain =  document.querySelector('.modal-left-top img').src;
     var smallImg = document.querySelectorAll('.modal-left-bottom-item img').src

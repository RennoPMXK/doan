    ...
    for(let i = 0; i < arr_product.length; i++) {
      if(arr_product[i].loai === type) {
            ...
            <div class="menu-best-sale-content-item-img">
                   <img src=${arr_product[i].anh} alt="" class="product-img">
            ...
            <div class="menu-best-sale-content-item-content">
                 <h3 class="item-content-name">${arr_product[i].ten}</h3>
                 <div class="price">
                     <div class="price-old"><del>${arr_product[i].giacu}</del></div>
                     <div class="price-new">${arr_product[i].giamoi}</div>
                 </div>
            </div>
           </div>
            `

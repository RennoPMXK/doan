...
function ModalCart(anh,ten,gia){
     ...
     var cartShopping = document.querySelector('.cart-table-list:first-of-type')
     ...
     cartItem.innerHTML = `
     <div class="cart-item">
     <div class="cart-shopping-top row">
         <div class="cart-shopping-top-left col-3">
             <img src="./img/nam2.jpg" alt="">
         </div>

         <div class="cart-shopping-top-right col-9">
             <div class="cart-shopping-top-right-item">
                 <h3>Axion</h3>
                 <p>4.600.000đ</p>
     ...
     updateCart()
     cartShopping.appendChild(cartItem)
     updateCart()
...
function updateCart() {
     var cartItemList = document.getElementsByClassName('cart-table-list')[1]
     var textQuantity = document.querySelector(' .cart-shopping-top-right-item p span').innerHTML 

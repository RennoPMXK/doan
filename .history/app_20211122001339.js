...
let BtnsAdd = document.querySelectorAll('product-icon:last-of-type')
console.log(BtnsAdd)

function ModalCart(anh,ten,gia){
     var BtnsAdd =  document.querySelectorAll('.quantity')
     for(let i = 0; i < BtnsAdd.length; i++){
     var BtnAdd = BtnsAdd[i]
     BtnAdd.addEventListener('click', function(){
          alert('hihi')
     })
     modal.classList.add('active');
     modalCart.style.display = 'block';
     var cartList = document.querySelector('.cart-table')
     ...
     <td width ="170px">
             ...
             <input onchange="updateCart()" class="quantity" type="number" min="1" value="1">
     </td>

...
function ModalCart(anh,ten,gia){
     ...
     var cartShopping = document.querySelector('.cart-shopping-list')
     ...
     <div class="cart-shopping-top-right col-9">
         <h2>${ten}</h2>
         <p>${gia}</p>
         <input onchange = "updateCart()"  class="quantityCart" type="number" min="1" >
     </div>
    </div>

     <div class="cart-shopping-bottom">
        <div class="cart-shopping-total">
            <h3>Tổng tiền tạm tính: </h3>
            <h3 id = "number-total" >9.400.000đ</h3>
        </div>

...
function renderProduct(arr) {
   ...
   for(let i = 0; i < arr.length; i++){
        ...
        <img src= ${arr[i].anh} alt="" class="product-img">
               <i class='bx bx-bullseye product-icon'onclick="ModalProduct('arr[i].anh')"></i>
...
function ModalProduct(anh) {
     modal.classList.add('active');
     modalProduct.style.display = 'block';   
     document.querySelector('.modal-left-top img').src = /img/nam1.jpg
}
